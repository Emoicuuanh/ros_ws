...
class OdomMotion(Node):
    def __init__(self):
        ...
        self.odom_sub_ = self.create_subscription(Odometry,"my_robot/odom",self.odomCallback,10)
        self.pose_array_pub_ = self.create_publisher(PoseArray,"my_robot/samples",10)
