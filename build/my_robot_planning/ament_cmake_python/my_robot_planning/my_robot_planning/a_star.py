...
class Astar_planner(Node):
    def __init__(self):
        ...
        self.map_sub = self.create_subscription(OccupancyGrid,"/global_costmap/costmap",self.map_callback,map_qos)
        ...
        self.map_pub = self.create_publisher(OccupancyGrid,"a_star/visitedmap",10)
    ...
    def plan(self,start,goal):
        ...
        while not pending_node.empty() and rclpy.ok():
            ...
            self.visited_map.data[self.pose_to_cell(new_node)] = -106
